  ...
  const nodes: Node[] = [
    ...
    },
    {
      ...
      data: {
        ...
        badge: "Processing",
        badgeColor:
          "text-[color:var(--accent)] border-[var(--accent)]/25 bg-[var(--accent)]/10",
        active: true,
      },
    },
    {
...
function Ticker() {
  const items = [
    {
      text: "FlowFrame DSL (.flow) — Declarative architecture compiler & engine",
      icon: <ZapIcon className="w-3 h-3 text-[color:var(--accent)] shrink-0" />,
    },
    {
      text: "Monaco Code Editor — Real-time syntax highlighting & autocompletion",
      icon: <CodeIcon className="w-3 h-3 text-[color:var(--green)] shrink-0" />,
    },
    {
      text: "API Gateway — Path-based routing to Server & LoadBalancer clusters",
      icon: (
        <NodeLinkIcon className="w-3 h-3 text-[color:var(--muted)] shrink-0" />
      ),
    },
    {
      text: "Load Balancing — Round Robin & IP Hash traffic distribution",
      icon: (
        <ScaleIcon className="w-3 h-3 text-[color:var(--amber)] shrink-0" />
      ),
    },
    {
      text: "RabbitMQ Queue — Asynchronous message buffering & consumer prefetch",
      icon: <InboxIcon className="w-3 h-3 text-[color:var(--red)] shrink-0" />,
    },
    {
      text: "PubSub Broker — Multi-subscriber event fan-out & topic channels",
      icon: (
        <BroadcastIcon className="w-3 h-3 text-[color:var(--accent)] shrink-0" />
      ),
    },
    {
      text: "Cache-Aside — Redis hit/miss & PostgreSQL database fallback",
      icon: (
        <DatabaseIcon className="w-3 h-3 text-[color:var(--muted)] shrink-0" />
      ),
    },
    {
      text: "Interactive Docs (/docs) — Comprehensive language reference & API schemas",
      icon: <DocsIcon className="w-3 h-3 text-[color:var(--green)] shrink-0" />,
    },
  ];
      ...
      <section className="relative mx-auto max-w-6xl px-4 sm:px-6 py-24 sm:py-28 overflow-hidden">
        <div className="relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <Badge
              variant="outline"
              className="mb-2 font-mono text-[10px] uppercase tracking-widest text-primary border-primary/25 bg-primary/5"
            >
              The Core Experience
            </Badge>
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              No static mockups. FlowFrame compiles your topology into an
              executable simulation graph.
            </p>
          </div>
              ...
              <Reveal key={s.step} delay={i * 0.06}>
                <div className="relative flex flex-col rounded-xl border border-border bg-card p-5 hover:border-primary/40 hover:shadow-md transition-all duration-200 h-full shadow-xs">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge
                      variant="outline"
                      className="text-[10px] font-mono font-bold text-muted-foreground bg-muted/40"
                    >
                      Step {s.step}
                    </Badge>
                  </div>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-20 border-t border-border">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            Most system design tools let you draw static boxes and arrows.
            FlowFrame executes the actual runtime behavior, captures every hop,
            and plays it back.
          </p>
        </div>
...
function Scenarios() {
  ...
  const tagColors: Record<string, string> = {
    Beginner:
      "text-[color:var(--green)] bg-[var(--green-muted)] border-[var(--green)]/25",
    Intermediate:
      "text-[color:var(--amber)] bg-[var(--amber-muted)] border-[var(--amber)]/25",
    Advanced:
      "text-[color:var(--red)] bg-[var(--red-muted)] border-[var(--red)]/25",
  };
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Pre-wired architectures with real engine logic. Select one and
          ...
          <Button
            variant="link"
            asChild
            className="text-primary font-semibold p-0 h-auto gap-1"
          >
            <Link href="/scenarios">
    ...
    <Reveal>
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-20 border-t border-border">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            Every distributed system in FlowFrame executes according to
            deterministic rules that mirror real-world production
            infrastructure.
          </p>
        </div>
          ...
          {rules.map((r, i) => (
            ...
            >
              <div className="flex items-start gap-3.5">
                <Badge
                  variant="outline"
                  className="text-[10px] font-mono font-bold text-muted-foreground shrink-0 px-2 py-0.5 bg-muted/30"
                >
                  {r.num}
                </Badge>
    ...
    <Reveal>
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-20 border-t border-border">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            Follow a full implementation of message queues, connection pools,
            and distributed request traces modeled in FlowFrame.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-card shadow-lg overflow-hidden">
          ...
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-border bg-muted/40 text-xs font-mono">
            ...
            <div className="flex items-center gap-2">
              <Badge
                variant="outline"
                className="gap-1.5 text-[10px] font-mono font-medium bg-primary/10 text-primary border-primary/25"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
            ...
            <div className="lg:col-span-5 p-6 sm:p-8 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-border">
              <div>
                <Badge
                  variant="outline"
                  className="text-[10px] font-mono font-bold text-primary border-primary/25 bg-primary/10 mb-4"
                >
                  SYSTEM DESIGN LAB
                </Badge>
                ...
                <p className="text-xs text-muted-foreground leading-relaxed mb-6">
                  Complete walkthrough covering API Gateway ingress, Round-Robin
                  load distribution, RabbitMQ pub/sub fan-out, and PostgreSQL
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-6">
                  <div className="p-2.5 rounded-lg border border-border bg-muted/20 flex flex-col">
                    ...
                    <span className="text-[11px] font-semibold text-card-foreground mt-0.5">
                      RabbitMQ Fan-Out
                    </span>
                  </div>
                  <div className="p-2.5 rounded-lg border border-border bg-muted/20 flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
                ...
                <Button
                  ...
                  size="sm"
                  asChild
                  className="gap-2 group shadow-xs"
                >
                  <a
                  ...
                  >
                    <svg
                      className="w-3.5 h-3.5 text-muted-foreground group-hover:text-red-500 transition-colors"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                    >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Free for education, personal learning, and non-commercial
                research. Released under PolyForm Noncommercial 1.0.0.
              </p>
            </div>
          </div>
          <Button
  ...
  return (
    <div className="relative min-h-screen bg-[var(--bg)] transition-colors duration-200 overflow-x-hidden">
      ...
      <section className="relative mx-auto max-w-6xl px-4 sm:px-6 pt-10 sm:pt-14 pb-16 text-center flex flex-col items-center">
        ...
        >
          FlowFrame is an interactive visual simulator and learning environment
          for distributed architectures. Design systems on a canvas, configure
          components, run real requests, and watch execution unfold — frame by
          frame.
        </p>
        ...
        >
          ...
          <Button
            ...
            size="sm"
            asChild
            className="h-8 gap-1.5 rounded-lg border-border bg-card"
          >
            <Link href="/workspace">
