  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[color:var(--foreground)] flex flex-col justify-between transition-colors duration-300">
      <SiteHeader
        ...
        showHomeLink={true}
        badgeText="Account Authentication"
        alwaysGlass={true}
      />
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-2">
            <div className="inline-flex items-center gap-2 rounded-full border border-violet-500/25 bg-violet-500/10 px-3 py-1 text-xs font-semibold text-violet-400">
              <span>FlowFrame Workspace</span>
            </div>
            ...
            <p className="text-xs sm:text-sm text-[color:var(--foreground)]/60">
              Sign in to manage your distributed system flows and simulations.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="text-xs font-semibold text-[color:var(--foreground)]/80 block">
                    Password
                  </label>
                  <a
                    href="#forgot"
              ...
              <div className="flex items-center justify-between pt-1">
                <label className="flex items-center gap-2 text-xs text-[color:var(--foreground)]/70 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={rememberMe}
              ...
              >
                {isLoading ? (
                  ...
                  <span>Sign In to FlowFrame →</span>
                )}
              </button>
            </form>
          </div>
